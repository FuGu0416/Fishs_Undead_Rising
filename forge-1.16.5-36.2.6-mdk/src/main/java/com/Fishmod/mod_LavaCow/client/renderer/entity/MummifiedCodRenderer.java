...
@OnlyIn(Dist.CLIENT)
public class MummifiedCodRenderer extends MobRenderer<MummifiedCodEntity, CodModel<MummifiedCodEntity>> {
	...
	public ResourceLocation getTextureLocation(MummifiedCodEntity p_110775_1_) {
		return TEXTURES;
	}

	protected void setupRotations(MummifiedCodEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
