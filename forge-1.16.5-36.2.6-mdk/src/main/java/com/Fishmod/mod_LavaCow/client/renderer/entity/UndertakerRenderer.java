...
public class UndertakerRenderer extends MobRenderer<UndertakerEntity, UndertakerModel<UndertakerEntity>> {
	private static final ResourceLocation TEXTURES_EYE = new ResourceLocation("mod_lavacow:textures/mobs/undertaker/undertaker_eyes.png");
	private static final ResourceLocation TEXTURES = new ResourceLocation("mod_lavacow:textures/mobs/undertaker/undertaker.png");
	static{
