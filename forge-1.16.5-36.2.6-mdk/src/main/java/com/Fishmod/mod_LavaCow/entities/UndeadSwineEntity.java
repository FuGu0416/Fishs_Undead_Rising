...
public class UndeadSwineEntity extends MonsterEntity implements IAggressive {
    ...
    public void push(Entity entityIn) {
		...
		if(this.entityAICharge != null && this.entityAICharge.isCharging())
		{
			...
			entityIn.setDeltaMovement(this.getLookAngle());
		}
    }
    ...
    static class AIChargeAttack extends Goal {
        ...
        public boolean canUse() {
           ...
           return LivingEntity != null && LivingEntity.isAlive() && LivingEntity.getY() <= this.charger.getY();
        }
        ...
        public void start() {
           this.attackStep = 0;
           this.charger.playSound(FURSoundRegistry.UNDEADSWINE_CHARGE, 4.0F, 1.0F);
        }
