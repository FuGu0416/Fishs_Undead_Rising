...
public class HolyGrenadeEntity extends ProjectileItemEntity {
	
    public HolyGrenadeEntity(EntityType<? extends HolyGrenadeEntity> p_i48540_1_, World worldIn) {
    	super(p_i48540_1_, worldIn);
    }

    public HolyGrenadeEntity(EntityType<? extends HolyGrenadeEntity> p_i48540_1_, LivingEntity throwerIn, World worldIn) {
    	super(p_i48540_1_, throwerIn, worldIn);
    }

    public HolyGrenadeEntity(EntityType<? extends HolyGrenadeEntity> p_i48540_1_, double x, double y, double z, World worldIn) {
	...
	protected Item getDefaultItem() {
		return FURItemRegistry.HOLY_GRENADE;
	}
