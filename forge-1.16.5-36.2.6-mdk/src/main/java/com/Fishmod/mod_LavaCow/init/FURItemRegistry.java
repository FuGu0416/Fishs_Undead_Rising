...
public class FURItemRegistry {
	...
	public static final Item ENIGMOTH_LARVA = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(2).saturationMod(0.3F).build()), 2).setRegistryName("mod_lavacow:enigmoth_larva");
