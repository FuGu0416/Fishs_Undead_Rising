...
public class FURItemRegistry {
	...
	public static final Item ENIGMOTH_LARVA = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(2).saturationMod(0.3F).effect(() -> new EffectInstance(FUREffectRegistry.VOID_SCALES, 20*20, 3), 0.3F).build())).setRegistryName("mod_lavacow:enigmoth_larva");
