...
public class FURItemRegistry {
	...
	public static final Item PARASITE_DESERT = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(2).saturationMod(0.3F).effect(() -> new EffectInstance(Effects.HUNGER, 30*20, 0), 0.3F).build()), 32, UseAction.EAT, 2).setRegistryName("mod_lavacow:parasite_item_desert");
	public static final Item PARASITE_JUNGLE = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(2).saturationMod(0.3F).effect(() -> new EffectInstance(Effects.POISON, 4*20, 0), 0.3F).build()), 32, UseAction.EAT, 2).setRegistryName("mod_lavacow:parasite_item_jungle");
	...
	public static final Item GREEN_BACON_AND_EGGS = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(10).saturationMod(1.2F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.DIG_SPEED, 60*20, 0), 1F).build()), 32, UseAction.EAT, 1).setRegistryName("mod_lavacow:green_bacon_and_eggs");
	...
	public static final Item PTERA_WING_JUNGLE = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(4).saturationMod(0.1F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.HUNGER, 30*20, 2), 0.8F).build()), 32, UseAction.EAT, 2).setRegistryName("mod_lavacow:ptera_wing_jungle");
	public static final Item PTERA_WING_DESERT = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(4).saturationMod(0.1F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.HUNGER, 30*20, 2), 0.8F).build()), 32, UseAction.EAT, 2).setRegistryName("mod_lavacow:ptera_wing_desert");
    ...
    public static void registerItem(RegistryEvent.Register<Item> event) {  	
    	...
    	event.getRegistry().register(new SpawnEggItem(FUREntityRegistry.LAVACOW, 0xFF2724, 0xFFDA24, new Item.Properties().tab(mod_LavaCow.TAB)).setRegistryName("mod_lavacow:spawn_egg_lavacow"));
    	...
    	event.getRegistry().register(new SpawnEggItem(FUREntityRegistry.CACTYRANT, 0x9FE664, 0xE0D6B1, new Item.Properties().tab(mod_LavaCow.TAB)).setRegistryName("mod_lavacow:spawn_egg_cactyrant"));
    	event.getRegistry().register(new SpawnEggItem(FUREntityRegistry.CACTOID, 0xABE97D, 0xE5DECD, new Item.Properties().tab(mod_LavaCow.TAB)).setRegistryName("mod_lavacow:spawn_egg_cactoid"));
