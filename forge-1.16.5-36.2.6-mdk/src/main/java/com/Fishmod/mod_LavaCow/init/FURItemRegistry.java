...
public class FURItemRegistry {
	...
	public static final Item PTERA_WING = new FURItem(new Item.Properties().tab(mod_LavaCow.TAB).food(new Food.Builder().nutrition(4).saturationMod(0.1F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.HUNGER, 30*20, 2), 0.8F).build()), 2).setRegistryName("mod_lavacow:ptera_wing");
    ...
    public static void registerItem(RegistryEvent.Register<Item> event) {  	
    	...
    	event.getRegistry().register(new ForgeSpawnEggItem(() -> FUREntityRegistry.WRAITH, 0x2DE6FD, 0x00353B, new Item.Properties().tab(mod_LavaCow.TAB)).setRegistryName("mod_lavacow:spawn_egg_wraith"));
