...
public class AvatonModel<T extends FloatingMobEntity> extends FURBaseModel<T> implements IHasArm, IHasHead {
    ...
    public AvatonModel() {
        ...
        this.Arm_r_Seg0.addBox(-2.0F, -1.0F, -2.0F, 2.0F, 12.0F, 2.0F, 0.0F, true);
        ...
        this.Arm_l_Seg2.setPos(2.0F, 1.0F, 0.0F);
        ...
        this.Arm_l_Seg0.addBox(0.0F, -1.0F, -2.0F, 2.0F, 12.0F, 2.0F, 0.0F, false);
        ...
        this.Body_chest.setPos(0.0F, -5.0F, -0.5F);
        ...
        this.Body_waist.addBox(-3.5F, -5.0F, -1.5F, 7.0F, 5.0F, 3.0F, 0.0F, false);
        ...
        this.Arm_r_Seg2.setPos(-2.0F, 1.0F, 0.0F);
        ...
        this.Arm_l_Seg0.addChild(this.Arm_l_Seg2);
        ...
        this.Arm_r_Seg0.addChild(this.Arm_r_Seg2);
    ...
    public void renderToBuffer(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body_base).forEach((modelRenderer) -> { 
            modelRenderer.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, Math.min(alpha, 0.85F));
        });
    }
