...
public class EntityFishAIAttackRange<T extends Fireball> extends Goal {
    ...
    public EntityFishAIAttackRange(PathfinderMob shooterIn, EntityType<T> shotIn, int timesIn, int attackCDIn) {
    ...
    public EntityFishAIAttackRange(PathfinderMob shooterIn, EntityType<T> shotIn, SoundEvent soundIn, int timesIn, int attackCDIn, double curveIn, double rangeIn) {
        this.shooter = shooterIn;
        this.shot = shotIn;
        this.sound = soundIn;
        this.shot_times = timesIn;
    ...
    public EntityFishAIAttackRange(PathfinderMob shooterIn, EntityType<T> shotIn, SoundEvent soundIn, int timesIn, int attackCDIn, double curveIn, double rangeIn, double XIn, double YIn, double ZIn) {
        this.shooter = shooterIn;
        this.shot = shotIn;
        this.sound = soundIn;
        this.shot_times = timesIn;
    ...
    public EntityFishAIAttackRange(PathfinderMob shooterIn, EntityType<T> shotIn, int timesIn, int attackCDIn, double XIn, double YIn, double ZIn) {
        this.shooter = shooterIn;
        this.shot = shotIn;
        this.sound = SoundEvents.BLAZE_SHOOT;
        this.shot_times = timesIn;
