...
public final class FURConfig {
	...
	public static final ForgeConfigSpec.ConfigValue<Integer> pSpawnRate_Mycosis;
	...
	public static final ForgeConfigSpec.ConfigValue<Integer> pSpawnRate_Frigid;
	...
	static {		
		...
		pSpawnRate_Mycosis = BUILDER.comment("Set the spawn rate of Mycosis [0-10000]").defineInRange("mycosis spawn rate", 40, 0, 10000);
		...
		BUILDER.push("Frigid");
		pSpawnRate_Frigid = BUILDER.comment("Set the spawn rate of Frigid [0-10000]").defineInRange("frigid spawn rate", 20, 0, 10000);
