 ...
 */
public class AvatonModel extends GeoModel<AvatonEntity> {
    ...
    @Override
    public ResourceLocation getTextureResource(AvatonEntity object) {
        return TEXTURES[object.getSkin()];
    }

    @Override
    public ResourceLocation getAnimationResource(AvatonEntity animatable) {
        return ANIMATIONS;
    }

	@Override
	public ResourceLocation getModelResource(AvatonEntity animatable) {
		return MODEL;
	}
    ...
    @Nullable
    @Override
	public RenderType getRenderType(AvatonEntity p_230496_1_, ResourceLocation texture) {
