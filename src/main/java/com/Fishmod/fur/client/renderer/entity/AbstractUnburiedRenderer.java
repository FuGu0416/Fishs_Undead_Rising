...
@OnlyIn(Dist.CLIENT)
public class AbstractUnburiedRenderer extends GeoEntityRenderer<UnburiedEntity> {
    ...
    public AbstractUnburiedRenderer(EntityRendererProvider.Context rendermanagerIn) {
		...
		addRenderLayer(new BlockAndItemGeoLayer<>(this) {
			...
			protected ItemStack getStackForBone(GeoBone bone, UnburiedEntity animatable) {
				...
				return switch (bone.getName()) {
					case LEFT_HAND -> animatable.isLeftHanded() ?
							AbstractUnburiedRenderer.this.mainHandItem : AbstractUnburiedRenderer.this.offhandItem;
					case RIGHT_HAND -> animatable.isLeftHanded() ?
							AbstractUnburiedRenderer.this.offhandItem : AbstractUnburiedRenderer.this.mainHandItem;
					default -> null;
				};
			}
			...
			protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, UnburiedEntity animatable,
				...
				if (stack == AbstractUnburiedRenderer.this.mainHandItem) {
					poseStack.mulPose(Axis.XP.rotationDegrees(-90f));

					if (stack.getItem() instanceof ShieldItem)
						poseStack.translate(0, 0.125, -0.25);
				}
				else if (stack == AbstractUnburiedRenderer.this.offhandItem) {
					poseStack.mulPose(Axis.XP.rotationDegrees(-90f));
