...
public class FURItemRegistry {
	...
	public static final RegistryObject<Item> MOOTEN_HEART = DEF_REG.register("mooten_heart", () -> new FURItem(new Item.Properties().rarity(Rarity.RARE), 0, UseAnim.NONE, 0));
	...
	*/
    ...
    static {
        ...
        spawnEgg("forsaken", FUREntityRegistry.FORSAKEN, 0xC1AE01, 0x494A09);
