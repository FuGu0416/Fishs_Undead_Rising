...
public class FURItemRegistry {
	...
	public static final RegistryObject<Item> GHOSTJELLY = DEF_REG.register("ghostjelly", () -> new FURStewItem(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(0.6F).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.SLOW_FALLING, 6*20, 2), 1.0F).build()), UseAnim.EAT, 1));
