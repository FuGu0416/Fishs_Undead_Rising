...
public class FURBlockRegistry {
	...
	public static final RegistryObject<Block> INFESTED_RED_SAND = registerBlocks("infested_red_sand", () -> new InfestedFallingBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).instrument(NoteBlockInstrument.SNARE).sound(SoundType.SAND).strength(0.25F)));
	public static final RegistryObject<Block> INFESTED_RED_SANDSTONE = registerBlocks("infested_red_sandstone", () -> new InfestedBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.4F)));
	public static final RegistryObject<Block> INFESTED_SAND = registerBlocks("infested_sand", () -> new InfestedFallingBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).instrument(NoteBlockInstrument.SNARE).sound(SoundType.SAND).strength(0.25F)));
	public static final RegistryObject<Block> INFESTED_SANDSTONE = registerBlocks("infested_sandstone", () -> new InfestedBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(0.4F)));
