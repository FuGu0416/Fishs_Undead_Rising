...
public class FURBlockRegistry {
	...
	public static final RegistryObject<Block> DREAMCATCHER = registerBlocks("dreamcatcher", () -> new DreamcatcherBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(0.4F).sound(SoundType.WOOL).noOcclusion().noCollission().pushReaction(PushReaction.DESTROY)));
	...
	public static final RegistryObject<Block> EMBERWICK_FUNGUS = registerBlocks("emberwick_fungus", () -> new EmberwickFungusBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).replaceable().noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ).ignitedByLava().pushReaction(PushReaction.DESTROY).lightLevel(state -> 3)));
