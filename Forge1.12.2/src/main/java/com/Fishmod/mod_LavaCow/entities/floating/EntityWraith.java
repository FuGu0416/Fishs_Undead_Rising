...
public class EntityWraith extends EntityFloatingMob implements IAggressive {
    ...
    public class AIUseSpell extends EntityAIBase {
        ...
        protected void castSpell() {
        	...
        	if (EntityWraith.this.getAttackTarget() != null) {
        		if (EntityWraith.this.getAttackTarget() instanceof EntityPlayer) {
        			EntityWraith.this.getAttackTarget().addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, 30 * 20, 0));
        			EntityWraith.this.getAttackTarget().addPotionEffect(new PotionEffect(ModMobEffects.FRAGILE, 30 * 20, 4));    
        		} else {
        			EntityWraith.this.getAttackTarget().addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 30 * 20, 2));
        			EntityWraith.this.getAttackTarget().addPotionEffect(new PotionEffect(MobEffects.ABSORPTION, 30 * 20, 2));        			
        		}
