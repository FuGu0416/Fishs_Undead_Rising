...
public class EntityForsakenAIFollowOwner extends EntityAIBase {
    private final EntityForsaken tameable;
    ...
    public EntityForsakenAIFollowOwner(EntityForsaken tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
