...
public class ModelWeta extends FishModelBase {
    ...
    public ModelWeta() {
        ...
        this.Antenna_Seg0_r.setRotationPoint(-1.0F, -2.0F, -4.0F);
        ...
        this.Antenna_Seg1_r.setRotationPoint(0.0F, 0.0F, -4.0F);
        ...
        this.Antenna_Seg0_l.setRotationPoint(1.0F, -2.0F, -4.0F);
        ...
        this.Antenna_Seg1_l.setRotationPoint(0.0F, 0.0F, -4.0F);
