...
public class ModelCactyrant extends FishModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) { 
    	float spl = (float)((EntityCactyrant)entityIn).getSpellTicks() / 20.0F;
    	float i = (float)((EntityCactyrant)entityIn).getAttackTimer() / 15.0F;  
    	...
    	if(((EntityCactyrant)entityIn).isCamouflaging()) {
    		this.Body_base.rotationPointY = 25.0F;
    		this.Leg0_Seg0.rotateAngleX = 0.0F;
    		this.Leg1_Seg0.rotateAngleX = 0.0F;
    		this.Leg2_Seg0.rotateAngleX = 0.0F;
    	} else {
    		this.Body_base.rotationPointY = 19.5F - 0.5F * MathHelper.sin(limbSwing * 1.2F);
    	...
    	switch(((EntityCactyrant)entityIn).getGrowingStage()) {
	    	case 0:
    	    	this.Head_Flower0.isHidden = true;
    	    	this.Limb0_Fruit0.isHidden = true;
    	    	this.Limb0_Fruit1.isHidden = true;
    	    	this.Limb0_Fruit2.isHidden = true;
    	    	this.Limb1_Fruit0.isHidden = true;
    	    	this.Limb1_Fruit1.isHidden = true;
	    		break;
	    	case 1:
    	    	this.Head_Flower0.isHidden = false;
    	    	this.Limb0_Fruit0.isHidden = true;
    	    	this.Limb0_Fruit1.isHidden = true;
    	    	this.Limb0_Fruit2.isHidden = true;
    	    	this.Limb1_Fruit0.isHidden = true;
    		...
    		default:
    	    	this.Head_Flower0.isHidden = false;
    	    	this.Limb0_Fruit0.isHidden = false;
    	    	this.Limb0_Fruit1.isHidden = false;
    	    	this.Limb0_Fruit2.isHidden = false;
    	    	this.Limb1_Fruit0.isHidden = false;
    	    	this.Limb1_Fruit1.isHidden = false;
    			break;
    	}
    	
    	if(((EntityCactyrant)entityIn).isBeingRidden()) {
    		this.Body_Seg1.rotateAngleX = 0.0F;
    		this.Body_Seg1.rotateAngleY = 0.0F;
    		this.Body_Seg2.rotateAngleX = 0.0F;
    		this.Body_Seg2.rotateAngleY = 0.0F;
    		this.Limb0_Seg0.rotateAngleX = 1.3693853151357844F;
    		this.Limb0_Seg0.rotateAngleY = 0.9382889765773795F;
    		this.Limb0_Seg1.rotateAngleX = 0.0F;
    		this.Limb0_Seg1.rotateAngleZ = 0.27314402793711257F;
    		this.Limb1_Seg0.rotateAngleX = -2.111499387652284F;
    		this.Limb1_Seg0.rotateAngleY = 1.9296359783943533F;
    		this.Limb1_Seg0.rotateAngleZ = 0.22759093446006054F;  
    	} else if(spl > 0.0F) {
    		this.Body_Seg1.rotateAngleX = 0.0F;
    		this.Body_Seg1.rotateAngleY = (float) (Math.PI * 10.0F * (1.0F - spl));
    		this.Body_Seg2.rotateAngleX = 0.0F;
    		this.Body_Seg2.rotateAngleY = 0.0F;
    		this.Limb0_Seg0.rotateAngleX = 1.3693853151357844F;
    		this.Limb0_Seg0.rotateAngleY = 0.0F;
    		this.Limb0_Seg1.rotateAngleX = 0.0F;
    		this.Limb0_Seg1.rotateAngleZ = 0.27314402793711257F;
    		this.Limb1_Seg0.rotateAngleX = 1.407433498155583F;
    		this.Limb1_Seg0.rotateAngleY = 3.141592653589793F;
    		this.Limb1_Seg0.rotateAngleZ = 0.22759093446006054F;	
    	} else if (i > Anime_threshold[1]) {
    		Anime_ctrl = j * (i - Anime_threshold[1]);
    		this.Body_Seg1.rotateAngleX = 0.0F;
    		this.Body_Seg1.rotateAngleY = GradientAnimation_s(0.0F, -0.5082398928281348F, Anime_ctrl);
    		this.Body_Seg2.rotateAngleX = 0.0F;
    		this.Body_Seg2.rotateAngleY = GradientAnimation_s(0.0F, -0.23457224414434488F, Anime_ctrl);
    		this.Limb0_Seg0.rotateAngleX = 0.0F;
    		this.Limb0_Seg0.rotateAngleY = 0.0F;
    		this.Limb0_Seg1.rotateAngleX = 0.0F;
    		this.Limb0_Seg1.rotateAngleZ = GradientAnimation_s(0.27314402793711257F, 0.5077162820683115F, Anime_ctrl);
    		this.Limb1_Seg0.rotateAngleX = 0.0F;
    		this.Limb1_Seg0.rotateAngleY = 3.141592653589793F;
    		this.Limb1_Seg0.rotateAngleZ = GradientAnimation_s(0.22759093446006054F, -0.3979350561389017F, Anime_ctrl);	   
    	} else if (i > Anime_threshold[2]) {
    		Anime_ctrl = k * (i - Anime_threshold[2]);   
    		this.Body_Seg1.rotateAngleX = GradientAnimation(0.0F, 0.6257005102083563F, Anime_ctrl);
    		this.Body_Seg1.rotateAngleY = GradientAnimation(-0.5082398928281348F, 0.19547687289441354F, Anime_ctrl);
    		this.Body_Seg2.rotateAngleX = GradientAnimation(0.0F, 0.6255260065779288F, Anime_ctrl);
    		this.Body_Seg2.rotateAngleY = GradientAnimation(-0.23457224414434488F, 0.23457224414434488F, Anime_ctrl);
    		this.Limb0_Seg0.rotateAngleX = 0.0F;
    		this.Limb0_Seg0.rotateAngleY = GradientAnimation(0.0F, 0.7037167490777915F, Anime_ctrl);
    		this.Limb0_Seg1.rotateAngleX = GradientAnimation(0.0F, 0.7428121536172365F, Anime_ctrl);
    		this.Limb0_Seg1.rotateAngleZ = 0.5077162820683115F;
    		this.Limb1_Seg0.rotateAngleX = 0.0F;
    		this.Limb1_Seg0.rotateAngleY = GradientAnimation(3.141592653589793F, -3.141592653589793F, Anime_ctrl);
    		this.Limb1_Seg0.rotateAngleZ = -0.3979350561389017F;	
    	} else if (i > 0.0F) {
    		Anime_ctrl = l * i;       	
    		this.Body_Seg1.rotateAngleX = GradientAnimation_s(0.6257005102083563F, 0.0F, Anime_ctrl);
    		this.Body_Seg1.rotateAngleY = GradientAnimation_s(0.19547687289441354F, 0.0F, Anime_ctrl);
    		this.Body_Seg2.rotateAngleX = GradientAnimation_s(0.6255260065779288F, 0.0F, Anime_ctrl);
    		this.Body_Seg2.rotateAngleY = GradientAnimation_s(0.23457224414434488F, 0.0F, Anime_ctrl);
    		this.Limb0_Seg0.rotateAngleX = 0.0F;
    		this.Limb0_Seg0.rotateAngleY = GradientAnimation_s(0.7037167490777915F, 0.0F, Anime_ctrl);
    		this.Limb0_Seg1.rotateAngleX = GradientAnimation_s(0.7428121536172365F, 0.0F, Anime_ctrl);
    		this.Limb0_Seg1.rotateAngleZ = GradientAnimation_s(0.5077162820683115F, 0.27314402793711257F, Anime_ctrl);
    		this.Limb1_Seg0.rotateAngleX = 0.0F;
    		this.Limb1_Seg0.rotateAngleY = GradientAnimation_s(-3.141592653589793F, 3.141592653589793F, Anime_ctrl);
    		this.Limb1_Seg0.rotateAngleZ = GradientAnimation_s(-0.3979350561389017F, 0.22759093446006054F, Anime_ctrl);	 
    	} else {
    		this.Body_Seg1.rotateAngleX = 0.0F;
    		this.Body_Seg1.rotateAngleY = 0.0F;
    		this.Body_Seg2.rotateAngleX = 0.0F;
