...
public class ModelLilSludge extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.Body.rotateAngleZ = MathHelper.cos(limbSwing * f) * 0.2F * limbSwingAmount;

        if (this.isRiding) {
            this.Leg_r.setRotationPoint(-2.0F, -0.5F, -2.0F);
            this.Leg_r.rotateAngleX = -1.602910321115726F;
            this.Leg_l.setRotationPoint(2.0F, -0.5F, -2.0F);
            this.Leg_l.rotateAngleX = -1.602910321115726F;
        } else {
            this.Leg_r.setRotationPoint(-2.0F, 0.0F, 0.0F);
            this.Leg_r.rotateAngleX = MathHelper.cos(limbSwing * f) * 0.7F * limbSwingAmount;
            this.Leg_r.rotateAngleZ = MathHelper.cos(limbSwing * f) * 0.2F * limbSwingAmount;
            this.Leg_l.setRotationPoint(2.0F, 0.0F, 0.0F);
            this.Leg_l.rotateAngleX = MathHelper.cos(limbSwing * f + (float) Math.PI) * 0.7F * limbSwingAmount;
            this.Leg_l.rotateAngleZ = MathHelper.cos(limbSwing * f) * 0.2F * limbSwingAmount;
        }
        ...
        /*if (isAggressive) {
            ...
            this.Arm_r.rotateAngleX = MathHelper.cos(limbSwing * f + (float) Math.PI);
            this.Arm_l.rotateAngleX = MathHelper.cos(limbSwing * f);
        }*/
