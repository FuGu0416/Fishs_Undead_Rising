...
public class Modconfig {
	...
	private void syncConfigs() {
		...
		SkeletonKing_Ability_Summon_Num = config.get("Skeleton King", "skeleton king summon number", 4, "Set the number of Forsaken summoned per cast [0-100]", 0, 100).getInt(4);
		...
		pSpawnRate_Grave_Robber_Ghost = config.get("Ghost of Grave Robber", "grave robber ghost spawn rate", 50, "The chance for a Ghost of Grave Robber to appear after a Grave Robber dies [0-100]", 0, 100).getInt(50);
