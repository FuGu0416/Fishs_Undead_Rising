...
public class ModelBoneWorm extends FishModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    	...
    	if (j > 0) {
    		...
    		f = 3.5F;
    		g = 0.5F;
        	this.Appendage_r0_seg0.rotateAngleY = 0.6829473363053812F + (f * -0.16F * MathHelper.sin(f * g * ageInTicks));
        	this.Appendage_r0_seg1.rotateAngleY = (f * -0.25F * MathHelper.sin(g * ageInTicks));
        	this.Appendage_r1_seg0.rotateAngleY = 0.6829473363053812F + (f * -0.16F * MathHelper.sin(f * g * ageInTicks + 0.25F * (float)Math.PI));
        	this.Appendage_r1_seg1.rotateAngleY = (f * -0.25F * MathHelper.sin(g * ageInTicks + 0.25F * (float)Math.PI));
        	this.Appendage_l0_seg0.rotateAngleY = -0.6829473363053812F + (f * -0.16F * MathHelper.sin(f * g * ageInTicks + 0.50F * (float)Math.PI));
        	this.Appendage_l0_seg1.rotateAngleY = (f * -0.25F * MathHelper.sin(g * ageInTicks + 0.50F * (float)Math.PI));
        	this.Appendage_l1_seg0.rotateAngleY = -0.6829473363053812F + (f * -0.16F * MathHelper.sin(f * g * ageInTicks + 0.75F * (float)Math.PI));
        	this.Appendage_l1_seg1.rotateAngleY = (f * -0.25F * MathHelper.sin(g * ageInTicks + 0.75F * (float)Math.PI));
    		...
    		this.Appendage_l0_seg0.rotateAngleY = GradientAnimation(-1.6845917940249266F, -1.6390387005478748F, (float)i / 15.0F);
    		...
    		this.Appendage_r0_seg0.rotateAngleY = GradientAnimation(-1.6845917940249266F, -1.6390387005478748F, (float)i / 15.0F);
        	...
        	this.Body_seg0.rotateAngleX = 0.27314402793711257F + (f * -0.07F * MathHelper.sin(0.03F * ageInTicks));
        	this.Body_seg1.rotateAngleX = 0.27314402793711257F + (f * -0.07F * MathHelper.sin(0.03F * ageInTicks));
        	this.Body_seg2.rotateAngleX = 0.6829473363053812F + (f * -0.07F * MathHelper.sin(0.03F * ageInTicks));  
    	}
    }
}
