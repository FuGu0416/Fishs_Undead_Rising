...
public class AddRecipes {
    ...
    public static void addSmelting() {
        ...
        Smelt_Recipe.add(new ImmutableTriple<Item, Item, Integer>(FishItems.LAMPREY, FishItems.LAMPREY_COOKED, 1));
    ...
    public static void addOreDictionary() {
        ...
        OreDictionary.registerOre("bone", FishItems.BONE_TROUT);
    }
