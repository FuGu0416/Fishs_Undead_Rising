...
import com.Fishmod.mod_LavaCow.blocks.BlockDiseasedHay;
...
public class Modblocks {
    ...
    public static final BlockDiseasedHay DISEASED_HAY_BLOCK = new BlockDiseasedHay();
    ...
    @ObjectHolder("diseased_hay_block")
    public static final ItemBlock item_block_diseased_hay = null;
