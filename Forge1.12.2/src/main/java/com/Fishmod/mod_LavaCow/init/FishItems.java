...
public class FishItems {
    ...
    public static ArmorMaterial ARMOR_GHOSTLY = EnumHelper.addArmorMaterial("armor_ghostly", "ghostly", 31, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F);
