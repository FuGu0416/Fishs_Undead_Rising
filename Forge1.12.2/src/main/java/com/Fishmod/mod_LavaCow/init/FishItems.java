...
import com.Fishmod.mod_LavaCow.item.*;
...
public class FishItems {
    ...
    public static final Item GHOST_SWARMER_ITEM = new ItemFishCustomFood("ghost_swarmer_item", 2, 0.1F, false, 32, false).setPotionEffect(new PotionEffect(ModMobEffects.RAVENS_GRACE, 20 * 20, 0), 0.3F);
    ...
    public static final Item MUMMIFIED_COD = new ItemFishCustomFood("mummified_cod", 2, 0.1F, false, 32, false).setPotionEffect(new PotionEffect(ModMobEffects.CORRODED, 20 * 20, 0), 0.3F);
    public static final Item BONE_TROUT = new ItemFishCustom("bone_trout", null, mod_LavaCow.TAB_ITEMS, false);
    public static final Item LAMPREY = new ItemFishCustomFood("lamprey", 2, 0.1F, false, 32, false).setPotionEffect(new PotionEffect(MobEffects.NAUSEA, 20 * 20, 0), 0.3F);
    public static final Item LAMPREY_COOKED = new ItemFishCustomFood("lamprey_cooked", 6, 0.8F, false, 32, false);
    public static final Item LAMPREY_KABAYAKI = new ItemFishCustomFood("lamprey_kabayaki", 9, 1.2F, false, 32, false);
    ...
    public static final Item GHOUL_ARROW = new ItemFishCustomArrow("ghoul_arrow");
    public static final Item FANG_ARROW = new ItemFishCustomArrow("fang_arrow");
