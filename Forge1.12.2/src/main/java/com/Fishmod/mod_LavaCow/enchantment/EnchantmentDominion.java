...
public class EnchantmentDominion extends Enchantment {
    public EnchantmentDominion(String unlocalizedName, String registryName, EnumEnchantmentType type) {
    ...
    public boolean canApply(ItemStack stack) {
        return Modconfig.Enchantment_Enable ?
                (stack.getItem().equals(FishItems.UNDERTAKER_SHOVEL)
                        || stack.getItem().equals(FishItems.SLUDGE_WAND)
                        || stack.getItem().equals(FishItems.SCARAB_WAND))
                : false;
    }
